...
All colors in Uniform CSS are defined using HSL. This opens up the opportunity of adjusting saturation and lightness using utility properties. By doing so, colors can vary in both vibrancy and shade without drastically affecting the final CSS output size.

<div class="bg-silver-200 p-20 h-200px radius-md">
  <div class="grid grid-cols-4 leading-6 gap-18">
    <div class="ratio-square radius-sm bg-red"></div>
    <div class="ratio-square radius-sm bg-red bg-brighten-500"></div>
    <div class="ratio-square radius-sm bg-red bg-darken-200"></div>
    <div class="ratio-square radius-sm bg-red bg-lighten-800"></div>
  </div>
</div>

```html
<div class="bg-red ..."></div>
<div class="bg-red bg-brighten-500 ..."></div>
<div class="bg-red bg-darken-200 ..."></div>
<div class="bg-red bg-lighten-800 ..."></div>
```
...
<div class="bg-white border-1 border-silver-300 p-20 h-200px radius-md">
  <div class="grid grid-cols-1 leading-6 gap-18">
    <div class="flex align-items-center justify-content-center h-48 align-center radius-sm text-blue text-lighten-300">Light blue text</div>
    <div class="flex align-items-center justify-content-center h-48 align-center radius-sm bg-blue bg-darken-400 text-white">Dark blue background</div>
    <div class="flex align-items-center justify-content-center h-48 align-center radius-sm border-4 border-red border-lighten-800 border-brighten-500">Light and bright red border</div>
  </div>
</div>

```html
<div class="text-blue text-lighten-300 ..."></div>
<div class="bg-blue bg-darken-400 ..."></div>
<div class="border-red border-lighten-800 border-brighten-500 ..."></div>
```
...
<div class="bg-silver-200 p-20 h-200px radius-md">
  <div class="grid grid-cols-5 leading-6 gap-18">
    ...
    <div class="flex align-items-center justify-content-center h-56 text-white font-xs font-bold radius-sm bg-blue bg-brighten-100">100</div>
    <div class="flex align-items-center justify-content-center h-56 text-white font-xs font-bold radius-sm bg-blue bg-brighten-200">200</div>
    <div class="flex align-items-center justify-content-center h-56 text-white font-xs font-bold radius-sm bg-blue bg-brighten-300">300</div>
    <div class="flex align-items-center justify-content-center h-56 text-white font-xs font-bold radius-sm bg-blue bg-brighten-400">400</div>
    <div class="flex align-items-center justify-content-center h-56 text-white font-xs font-bold radius-sm bg-blue bg-brighten-500">500</div>
    <div class="flex align-items-center justify-content-center h-56 text-white font-xs font-bold radius-sm bg-blue bg-brighten-600">600</div>
    <div class="flex align-items-center justify-content-center h-56 text-white font-xs font-bold radius-sm bg-blue bg-brighten-700">700</div>
    <div class="flex align-items-center justify-content-center h-56 text-white font-xs font-bold radius-sm bg-blue bg-brighten-800">800</div>
    <div class="flex align-items-center justify-content-center h-56 text-white font-xs font-bold radius-sm bg-blue bg-brighten-900">900</div>
  </div>
</div>

```html
<div class="bg-blue ..."></div>
<div class="bg-blue bg-brighten-100 ..."></div>
<div class="bg-blue bg-brighten-200 ..."></div>
<div class="bg-blue bg-brighten-300 ..."></div>
<div class="bg-blue bg-brighten-400 ..."></div>
<div class="bg-blue bg-brighten-500 ..."></div>
<div class="bg-blue bg-brighten-600 ..."></div>
<div class="bg-blue bg-brighten-700 ..."></div>
<div class="bg-blue bg-brighten-800 ..."></div>
...
<div class="bg-silver-200 p-20 h-200px radius-md">
  <div class="grid grid-cols-5 leading-6 gap-18">
    <div class="flex align-items-center justify-content-center h-56 text-white font-xs font-bold radius-sm bg-blue">base</div>
    <div class="flex align-items-center justify-content-center h-56 text-white font-xs font-bold radius-sm bg-blue bg-deepen-100">100</div>
    <div class="flex align-items-center justify-content-center h-56 text-white font-xs font-bold radius-sm bg-blue bg-deepen-200">200</div>
    <div class="flex align-items-center justify-content-center h-56 text-white font-xs font-bold radius-sm bg-blue bg-deepen-300">300</div>
    <div class="flex align-items-center justify-content-center h-56 text-white font-xs font-bold radius-sm bg-blue bg-deepen-400">400</div>
    <div class="flex align-items-center justify-content-center h-56 text-white font-xs font-bold radius-sm bg-blue bg-deepen-500">500</div>
    <div class="flex align-items-center justify-content-center h-56 text-white font-xs font-bold radius-sm bg-blue bg-deepen-600">600</div>
    <div class="flex align-items-center justify-content-center h-56 text-white font-xs font-bold radius-sm bg-blue bg-deepen-700">700</div>
    <div class="flex align-items-center justify-content-center h-56 text-white font-xs font-bold radius-sm bg-blue bg-deepen-800">800</div>
    <div class="flex align-items-center justify-content-center h-56 text-white font-xs font-bold radius-sm bg-blue bg-deepen-900">900</div>
  </div>
</div>

```html
<div class="bg-blue ..."></div>
<div class="bg-blue bg-deepen-100 ..."></div>
<div class="bg-blue bg-deepen-200 ..."></div>
<div class="bg-blue bg-deepen-300 ..."></div>
<div class="bg-blue bg-deepen-400 ..."></div>
<div class="bg-blue bg-deepen-500 ..."></div>
<div class="bg-blue bg-deepen-600 ..."></div>
<div class="bg-blue bg-deepen-700 ..."></div>
<div class="bg-blue bg-deepen-800 ..."></div>
...
<div class="bg-silver-200 p-20 h-200px radius-md">
  <div class="grid grid-cols-5 leading-6 gap-18">
    <div class="flex align-items-center justify-content-center h-56 text-white font-xs font-bold radius-sm bg-blue">base</div>
    <div class="flex align-items-center justify-content-center h-56 text-white font-xs font-bold radius-sm bg-blue bg-lighten-100">100</div>
    <div class="flex align-items-center justify-content-center h-56 text-white font-xs font-bold radius-sm bg-blue bg-lighten-200">200</div>
    <div class="flex align-items-center justify-content-center h-56 text-white font-xs font-bold radius-sm bg-blue bg-lighten-300">300</div>
    <div class="flex align-items-center justify-content-center h-56 text-white font-xs font-bold radius-sm bg-blue bg-lighten-400">400</div>
    <div class="flex align-items-center justify-content-center h-56 text-white font-xs font-bold radius-sm bg-blue bg-lighten-500">500</div>
    <div class="flex align-items-center justify-content-center h-56 text-white font-xs font-bold radius-sm bg-blue bg-lighten-600">600</div>
    <div class="flex align-items-center justify-content-center h-56 text-white font-xs font-bold radius-sm bg-blue bg-lighten-700">700</div>
    <div class="flex align-items-center justify-content-center h-56 text-white font-xs font-bold radius-sm bg-blue bg-lighten-800">800</div>
    <div class="flex align-items-center justify-content-center h-56 text-white font-xs font-bold radius-sm bg-blue bg-lighten-900">900</div>
  </div>
</div>

```html
<div class="bg-blue ..."></div>
<div class="bg-blue bg-lighten-100 ..."></div>
<div class="bg-blue bg-lighten-200 ..."></div>
<div class="bg-blue bg-lighten-300 ..."></div>
<div class="bg-blue bg-lighten-400 ..."></div>
<div class="bg-blue bg-lighten-500 ..."></div>
<div class="bg-blue bg-lighten-600 ..."></div>
<div class="bg-blue bg-lighten-700 ..."></div>
<div class="bg-blue bg-lighten-800 ..."></div>
...
<div class="bg-silver-200 p-20 h-200px radius-md">
  <div class="grid grid-cols-5 leading-6 gap-18">
    <div class="flex align-items-center justify-content-center h-56 text-white font-xs font-bold radius-sm bg-blue">base</div>
    <div class="flex align-items-center justify-content-center h-56 text-white font-xs font-bold radius-sm bg-blue bg-darken-100">100</div>
    <div class="flex align-items-center justify-content-center h-56 text-white font-xs font-bold radius-sm bg-blue bg-darken-200">200</div>
    <div class="flex align-items-center justify-content-center h-56 text-white font-xs font-bold radius-sm bg-blue bg-darken-300">300</div>
    <div class="flex align-items-center justify-content-center h-56 text-white font-xs font-bold radius-sm bg-blue bg-darken-400">400</div>
    <div class="flex align-items-center justify-content-center h-56 text-white font-xs font-bold radius-sm bg-blue bg-darken-500">500</div>
    <div class="flex align-items-center justify-content-center h-56 text-white font-xs font-bold radius-sm bg-blue bg-darken-600">600</div>
    <div class="flex align-items-center justify-content-center h-56 text-white font-xs font-bold radius-sm bg-blue bg-darken-700">700</div>
    <div class="flex align-items-center justify-content-center h-56 text-white font-xs font-bold radius-sm bg-blue bg-darken-800">800</div>
    <div class="flex align-items-center justify-content-center h-56 text-white font-xs font-bold radius-sm bg-blue bg-darken-900">900</div>
  </div>
</div>

```html
<div class="bg-blue ..."></div>
<div class="bg-blue bg-darken-100 ..."></div>
<div class="bg-blue bg-darken-200 ..."></div>
<div class="bg-blue bg-darken-300 ..."></div>
<div class="bg-blue bg-darken-400 ..."></div>
<div class="bg-blue bg-darken-500 ..."></div>
<div class="bg-blue bg-darken-600 ..."></div>
<div class="bg-blue bg-darken-700 ..."></div>
<div class="bg-blue bg-darken-800 ..."></div>
